...
def _gemm1_body(
    ...
    *,
    ...
    # per-expert 64-bit re-base: b_load_s_base below is an i32 soffset, and it used
    # to carry `e * N_OUT * K_HALF`. That product overflows i32 well before the
    # buffer's own 32-bit voffset would: at NE=896, N_OUT=6144, K_HALF=1792 it
    # reaches 9.85e9 for the last expert. Fold the expert into the descriptor's
    # 64-bit base instead and keep the soffset expert-relative.
